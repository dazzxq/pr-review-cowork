...
echo ""
echo "=== Test trước khi bật production ==="
echo "  Trong Cowork conversation gõ:"
echo "    \"test the cowork network reachability\"   # Bước 1: check egress"
echo "    \"test the smtp send config\"              # Bước 2: check creds"
echo ""
echo "  Hoặc chạy local (chỉ test máy bạn, không phản ánh Cowork sandbox):"
echo "    python3 scripts/test_cowork_network.py"
echo "    python3 scripts/test_send.py [-i | --dry-run]"
echo ""
